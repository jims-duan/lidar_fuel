...
void MapROS::init() {
  ...
  proj_points_.resize(640 * 400 / (skip_pixel_ * skip_pixel_));
  point_cloud_.points.resize(640 * 400 / (skip_pixel_ * skip_pixel_));
  // proj_points_.reserve(640 * 400 / map_->mp_->skip_pixel_ / map_->mp_->skip_pixel_);
  proj_points_cnt = 0;
